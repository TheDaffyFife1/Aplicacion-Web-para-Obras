...
urlpatterns = [
    ...
    path('attendance_by_week_project/', views.attendance_by_week_project, name='attendance_by_project'),
    path('summary_week_data', views.summary_week_data, name='summary_week_data'),  # Ensure this is correctly set
    ...
    path('reporte_asistencia/pdf/<int:obra_id>/', reporte_asistencia_pdf, name='reporte_asistencia_pdf'),
